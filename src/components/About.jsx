...
const About = () => {
  return (
    <div id='about' className='min-h-screen flex flex-col pb-60 items-center justify-center'> 
        ...
        <div className='w-full flex items-center justify-between md:justify-center'>
            ...
            <div className=' relative max-w-[800px] rounded-xl bg-zinc-100 p-5 text-justify dark:bg-zinc-700 transition-colors'>
                <span className='absolute -left-5 top-20 scale-[2.4] text-zinc-100 md:hidden dark:text-zinc-700'>{arrowLeftIcon}</span>
                <p className='text-lg font-light text-gray-700 first-letter:pl-4 lg:text-[16px] sm:text-[14px] dark:text-white'>{aboutText}</p>
